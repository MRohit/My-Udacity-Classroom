...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mshowErrorText = (TextView) findViewById(R.id.show_error_message);
        // COMPLETED (17) Find the ProgressBar using findViewById
        mshowProgressBar = (ProgressBar) findViewById(R.id.progress_bar);
    ...
    void showWeatherDataView () {
        mshowErrorText.setVisibility(View.INVISIBLE);
    ...
    void showErrorMessage(){
        ...
        mshowErrorText.setVisibility(View.VISIBLE);
    }
