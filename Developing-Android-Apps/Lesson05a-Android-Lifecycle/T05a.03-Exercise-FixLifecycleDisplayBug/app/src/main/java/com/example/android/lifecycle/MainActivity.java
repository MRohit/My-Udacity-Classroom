...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(String allEvents:mLifecycleCallbacks) {
            mLifecycleDisplay.append(allEvents+"\n");
        }
        // COMPLTED (5) Clear mLifecycleCallbacks after iterating through it
    ...
    protected void onDestroy() {
        ...
        // callbacks (3) Add the ON_DESTROY String to the front of mLifecycleCallbacks
