...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        setSizeFromSharedPreferences(sharedPreferences);
        loadColorFromPreferences(sharedPreferences);
        // Register the listener
        sharedPreferences.registerOnSharedPreferenceChangeListener(this);
    }
    private void setSizeFromSharedPreferences(SharedPreferences sharedPreferences) {
        float size = Float.parseFloat(sharedPreferences.getString(getString(R.string.change_size_key),getString(R.string.size_default)));
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            ...
            loadColorFromPreferences(sharedPreferences);
        } else if(key.equals("change_size_key")) {
            setSizeFromSharedPreferences(sharedPreferences);
        }
    }
