    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case TASK_WITH_ID:
                ...
                count = db.delete(TaskContract.TaskEntry.TABLE_NAME,mSelection,mSelectionArgs);
                if(count < 1) {
                    throw new SQLException("No rows found:"+uri);
                }
                break;
            default:
                throw new UnsupportedOperationException("Operation not supported:"+uri);
        }
