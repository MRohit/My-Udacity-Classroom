...
public class ReminderUtilities {
    ...
    private static final int REMINDER_INTERNAL_SECONDS = 1;
    private static final int REMINDER_INTERVAL_SECONDS = (int) TimeUnit.MINUTES.toSeconds(REMINDER_INTERNAL_SECONDS);
    ...
    synchronized public static void scheduleChargingReminder(Context context) {
        ...
        Job myJob = jobDispatcher.newJobBuilder()
                ...
                .setRecurring(true)
                .setTrigger(Trigger.executionWindow(REMINDER_INTERNAL_SECONDS,REMINDER_INTERVAL_SECONDS+SYNC_FLEXTIME_SECONDS))
